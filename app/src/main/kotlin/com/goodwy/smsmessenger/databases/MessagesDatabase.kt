...
import com.goodwy.smsmessenger.interfaces.SmsDao
...
@Database(
    entities = [
        ...
        Draft::class,
        ReceivedSms::class  // ← NUEVO
    ],
    version = 12  // ← CAMBIAR de 11 a 12
)
...
abstract class MessagesDatabase : RoomDatabase() {
    ...
    abstract fun SmsDao(): SmsDao  // ← NUEVO
                ...
                synchronized(MessagesDatabase::class) {
                    if (db == null) {
                        db = Room.databaseBuilder(
                            ...
                            .addMigrations(MIGRATION_11_12)  // ← NUEVO
                            .build()
                    }
                }
            }
